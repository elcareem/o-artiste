...
const { prisma, hasDatabase, ready } = require('./db')('artistprofile');
...
const service = require('../src/services/artistService');
const { MIN_TRANSACTION_KOBO, MAX_TRANSACTION_KOBO } = require('../src/lib/escrowpay');
